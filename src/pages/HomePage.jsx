...
const PricingOptimizer = React.lazy(() => import("./pages/PricingOptimizer.jsx"));
const SupportOnboarding = React.lazy(() => import("./pages/SupportOnboarding.jsx")); // ✅ Aide
...
export default function AppModular() {
  ...
  const TABS = [
    ...
    { key: "pro", label: t("nav.help"), Comp: SupportOnboarding }, // ✅ use SupportOnboarding
