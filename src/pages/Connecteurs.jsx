...
const CONNECTORS = [
  { key: "stripe", name: "Stripe", Icon: CreditCard, desc: "Paiements en ligne" },
  { key: "bridge", name: "Bridge / Powens", Icon: Banknote, desc: "Banque FR (flux bancaires)" },
  { key: "shopify", name: "Shopify", Icon: Store, desc: "Boutique en ligne" },
  { key: "prestashop", name: "PrestaShop", Icon: ShoppingCart, desc: "E-commerce" },
  { key: "woocommerce", name: "WooCommerce", Icon: Boxes, desc: "E-commerce (WordPress)" },
  { key: "pennylane", name: "Pennylane", Icon: Building2, desc: "Comptabilité" },
  { key: "sage", name: "Sage", Icon: Building2, desc: "Comptabilité" },
  { key: "sumup", name: "SumUp", Icon: Calculator, desc: "Point de vente" },
  { key: "sheets", name: "Google Sheets", Icon: FileSpreadsheet, desc: "Source de données" },
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-slate-950 via-slate-950 to-slate-900 text-slate-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-white/70">
                  Les connecteurs arrivent. Préparez vos accès — tout sera plug-and-play.
                </span>
              </div>
            </div>
          </div>
      ...
      <header className="mx-auto max-w-6xl px-4 pt-10">
        ...
        >
          Centralisez vos ventes, paiements et banques. Pour l’instant, cette page
          est un aperçu visuel : les tuiles sont volontairement <em>désactivées</em>.
        </motion.p>
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 line-clamp-2 text-xs text-white/70">{desc}</p>
                  </div>
                </div>
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-1 text-xs text-white/70">
                Priorité : <strong>Stripe</strong> + <strong>Bridge/Powens</strong> →{" "}
                <strong>Shopify/Presta/Woo</strong> → <strong>Pennylane/Sage</strong>.
              </p>
            </div>
            <div className="text-xs text-white/60">
              Interface figée pour l’instant — activation prévue dans une prochaine release.
            </div>
          </div>
        </motion.div>
      </main>
