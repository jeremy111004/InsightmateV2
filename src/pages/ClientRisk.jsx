...
// Page: Clients à risque — Dashboard + Priorités (emails cliquables) + Upload CSV + Liste (tout plein écran, CSV connecté)
// Coller tel quel dans: src/pages/clientrisk.jsx
