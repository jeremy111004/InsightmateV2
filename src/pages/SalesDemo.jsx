...
function SalesDemo() {
  ...
  // ANCHOR: HANDLE_UPLOAD (unchanged logic, robust CSV parse)
  ...
  // Optional: Drag & Drop zone (does not change logic)
  ...
  const {
    ...
    // léger biais récent hors saison (identique)
  ...
  return (
    <div id="demo" className="space-y-4">
      ...
      <FadeIn immediate>
        ...
        >
          {/* Hidden file input bound to the button */}
          {/* ANCHOR: CSV_INPUT_HIDDEN */}
          <input
            ref={fileInputRef}
            type="file"
            accept=".csv,text/csv"
